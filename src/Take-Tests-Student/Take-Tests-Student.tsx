...
function TakeTestsStudent(){
    ...
    const handleAnswerChange = (idQuestion: string, newAnswer: string) => {
        ...
        const question = questionExam.find(question => question.questionId === idQuestion);
        ...
        setStudentAnswers(prevAnswers => {
            const existingAnswerIndex = prevAnswers.answers.findIndex(answer => answer.idQuestionExam === idQuestionExam);
            ...
            if (existingAnswerIndex !== -1) {
                ...
                // Add new answer
                return { ...prevAnswers, answers: [...prevAnswers.answers, { idQuestionExam, answer: newAnswer }] };
            }
        });
    };
    ...
    useEffect(() => {
        if (idStudentExam) {
            setStudentAnswers(prevAnswers => ({ ...prevAnswers, idStudentExam: idStudentExam }));
        }
    }, [idStudentExam]);
