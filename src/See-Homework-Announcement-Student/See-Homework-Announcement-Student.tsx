...
function Buttons({idCourses,idLecture,idHomeworkAnnouncement}: {idCourses: string | undefined , idLecture : string | undefined , idHomeworkAnnouncement: string}){
    return (<div>
                        ...
                        return (
                            <CardElongated key={index} title={homework.title} cardIndex={index} height={145}>
                                <Box sx={{ display: "flex" }}>
                                    ...
                                    >
                                        <Buttons idCourses={idCourses} idLecture={idLecture} idHomeworkAnnouncement={homework.idHomeworkAnnouncement} />
                                    </CardContent>
                                </Box>
                            </CardElongated>
                        );
