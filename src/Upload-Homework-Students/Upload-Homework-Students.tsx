...
function UploadHomeworkStudents({
  idHomeworkAnnouncement,
}: {
  idHomeworkAnnouncement: string | undefined;
}) {
  ...
  const [homeworkAnnouncement, setHomeworkAnnouncement] =
    useState<HomeworkAnnouncements>({
      idHomeworkAnnouncement: "",
      title: "",
      description: "",
      dueDate: "",
      ...
      if (currentDate > deadline) {
        ...
        try {
          const result = await fetch(
            `http://localhost:8081/api/v1/homework/upload/idHomeworkAnnouncement=${idHomeworkAnnouncement}/idStudent=${user.idUsers}`,
            {
              method: "POST",
              body: formData,
              credentials: "include",
