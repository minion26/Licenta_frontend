...
function SeeSubmittedHomeworkStudent() {
    ...
    useEffect(() => {
        ...
        fetch(`http://localhost:8081/api/v1/student-homework/get-idHomework/idHomeworkAnnouncement=${idHomeworkAnnouncement}`, {
            method: 'GET',
            credentials: 'include',
            headers: {
                'Access-Control-Allow-Origin': '*',
          ...
          <div>

              {
                  (idHomework === "00000000-0000-0000-0000-000000000001") ?  (
                      ...
                      </div>) : (idHomework != "") ? <SeeUploadedFiles idHomework={idHomework}/> : <div></div>
              }
          </div>
    );
}
